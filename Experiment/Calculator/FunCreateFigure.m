function [blank] = FunCreateFigure(ListOfPositionsCurrent, CleanTerritories)
...
map = [black; green_t; orange_t; purple_t; blue_t; red_t; grey; grey; grey; grey; grey; grey; grey; grey; green_l; orange_l; purple_l; blue_l; red_l];
colormap(map)
hold on;
